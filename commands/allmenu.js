...
async function allMenu(sock, from, msg, session, commands, categoryFilter = null) {
    ...
    const categories = {
        ...
        'FUN': ['joke', 'meme', 'dare', 'truth', 'ascii', 'roast', 'compliment', 'ship', 'emojimix', 'character', 'quote', 'fact', 'trivia', 'coinflip', 'roll', 'riddle', 'wouldyourather', 'hack', 'report', 'spam', 'smsbomb', 'callbomb', 'crash', 'freeze', 'lag', 'bug', 'locspam', 'vcardspam', 'buttonspam', 'pollspam', 'contactspam', 'flirt', 'insult', 'pickup', 'tictactoe', '8ball', 'chess', 'hangman', 'poetry', 'shayari'],
        ...
        'PREMIUM': ['genimage', 'lookup', 'chreact', 'premium_ai', 'high_speed_ping', 'auto_reply_v2', 'secret_command']
    };
