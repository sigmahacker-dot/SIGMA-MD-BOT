...
cmd({
  ...
  if (action === 'on') {
    ...
    await m.reply("✅ *Anti-link enabled!* Links will now be auto-deleted 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗦𝗜𝗚𝗠𝗔 𝗠𝗗 𝗕𝗢𝗧.");
  } 
  else if (action === 'off') {
    config.ANTI_LINK = 'false';
    await m.reply("❌ *Anti-link disabled!* Links are now allowed 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬𝗦𝗜𝗚𝗠𝗔 𝗠𝗗 𝗕𝗢𝗧.");
  } 
  else {
