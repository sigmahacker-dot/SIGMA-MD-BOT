...
global.rentbotTracker = rentbotTracker;
if (!global.pairEvents) global.pairEvents = new EventEmitter();
...
async function startpairing(kingbadboiNumber) {
    ...
    bad.newsletterReactMessage = async (jid, messageId, emoji) => {
        return await bad.newsletterMsg(jid, { react: emoji, id: messageId });
    };
